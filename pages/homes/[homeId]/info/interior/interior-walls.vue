...
const pageEdit = ref()
const page_title = ref("Interior Walls")
const project_type = ref("interior_walls_inspection")
...
onMounted(() => {
    ...
    getDoc(docRef).then((docSnap) => {
        if (docSnap.exists()) {
            ...
            if (property.info && property.info.interior && property.info.interior.interiorWalls) {
                pageSource.value = property.info.interior.interiorWalls
            }
            else {
            pageSource.value = {
                ...pageTemplate.value
