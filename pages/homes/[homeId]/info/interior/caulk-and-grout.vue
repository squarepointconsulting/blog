...
const pageEdit = ref()
const page_title = ref("Caulk and Grout")
const project_type = ref("caulk_and_grout_inspection")
...
onMounted(() => {
    ...
    getDoc(docRef).then((docSnap) => {
        if (docSnap.exists()) {
            ...
            if (property.info && property.info.interior && property.info.interior.caulkAndGrout) {
                pageSource.value = property.info.interior.caulkAndGrout
            }
            else {
            pageSource.value = {
                ...pageTemplate.value
